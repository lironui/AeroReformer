...
def get_parser():
    ...
    parser.add_argument('--max_seq_length', default=20, type=int, help='maximum number of tokens for BERT input')
    parser.add_argument('--ck_bert', default='bert-base-uncased', help='pre-trained BERT weights')
    parser.add_argument('--dataset', default='uavid_ris', help='uavid_ris or vdd_ris')
    ...
    parser.add_argument('--model_id', default='AeroReformer', help='name to identify the model')
    ...
    parser.add_argument('--refer_data_root', default='./data/UAVid/', help='REFER dataset root directory')
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    parser.add_argument('--split', default='test', help='only used when testing')
    parser.add_argument('--splitBy', default='uow',
